...
| [boot-backend-rewrite.md](boot-backend-rewrite.md) | Rewrite the boot Wasm backend around explicit closure ABI rewriting, backend slot assignment, representation assignment, and verifier-checked prepared IR |
