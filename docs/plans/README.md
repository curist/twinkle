...
| [dict-performance-enhancements.md](dict-performance-enhancements.md) | Incrementally optimize the current erased HAMT dict runtime used by the boot compiler |
