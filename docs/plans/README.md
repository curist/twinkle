...
| [prelude-stdlib-type-interfaces.md](prelude-stdlib-type-interfaces.md) | Unlock prelude methods whose signatures return stdlib-defined types, starting with `Vector.chunks` / `Vector.windows` returning `View` windows |
