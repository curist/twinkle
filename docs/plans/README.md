...
| Boot LSP query layer | Make boot LSP diagnostics workspace-aware and expose reusable semantic query artifacts | In Progress | [boot-lsp-query-layer.md](boot-lsp-query-layer.md) |
