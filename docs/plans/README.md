...
| Full lib-export ABI | Widen lib exports beyond primitives: `String` + callbacks + compounds (shipped), returned closures, with bridge-backed `loadLib` marshalling | In Progress | [lib-export-abi.md](lib-export-abi.md) |
