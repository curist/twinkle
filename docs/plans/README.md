...
| Fixer | `twk fix`: apply safe meaning-preserving rewrites (inherent-method-call now, design in [inherent-method-hint.md](inherent-method-hint.md); unused-imports later); `--check` for CI | Planned | [fix.md](fix.md) |
