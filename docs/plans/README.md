...
| Contract call resolution | Resolve builtin contract method calls through exact nominal method identity instead of fallback name scans | Planned | [contract-call-resolution.md](contract-call-resolution.md) |
