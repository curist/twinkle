...
**Goal:** Build a multi-module columnar dataframe / query engine in Twinkle (`examples/performance/dataframe/`), exercised over large synthetic datasets, to stress-test app-level ergonomics + stdlib breadth and collection performance — producing both a working engine and a friction-log document.
...
- **Project root:** `examples/performance/dataframe/` has its own `twinkle.toml`, so module paths resolve from there: `use frame.cell`, `use frame.column`, `use tests.cell_suite`, `use runner`, `use assert`.
- **Test entrypoint:** `examples/performance/dataframe/main.tw` imports each suite module and calls `runner.run_all([...])`. Each task that adds a suite also wires it into `main.tw`.
- **Run all tests:** `target/twk run examples/performance/dataframe/main.tw`
- **Run one suite (TDD inner loop):** `TWK_TEST_FILTER="<suite name>" target/twk run examples/performance/dataframe/main.tw`
...
- **Format after editing:** `target/twk fmt examples/performance/dataframe/<file>.tw` (formatter is idempotent).
...
**Files:**
- Create: `examples/performance/dataframe/twinkle.toml`
- Create: `examples/performance/dataframe/assert.tw` (copy of `boot/tests/assert.tw`)
- Create: `examples/performance/dataframe/runner.tw` (copy of `boot/tests/runner.tw`)
- Create: `examples/performance/dataframe/main.tw`
- Create: `examples/performance/dataframe/tests/cell_suite.tw`

- [ ] **Step 1: Create the project root and copy the harness**

```bash
mkdir -p examples/performance/dataframe/frame examples/performance/dataframe/tests examples/performance/dataframe/bench
printf 'name = "dataframe"\n' > examples/performance/dataframe/twinkle.toml
cp boot/tests/assert.tw examples/performance/dataframe/assert.tw
cp boot/tests/runner.tw examples/performance/dataframe/runner.tw
```
...
```bash
git add examples/performance/dataframe
...
**Files:**
- Create: `examples/performance/dataframe/frame/cell.tw`
- Modify: `examples/performance/dataframe/tests/cell_suite.tw`

- [ ] **Step 1: Write the failing tests**

Replace `examples/performance/dataframe/tests/cell_suite.tw` with:
...
Run: `TWK_TEST_FILTER="cell" target/twk run examples/performance/dataframe/main.tw`
Expected: PASS — `cell` suite green.

Then format: `target/twk fmt examples/performance/dataframe/frame/cell.tw`

- [ ] **Step 5: Commit**

```bash
git add examples/performance/dataframe/frame/cell.tw examples/performance/dataframe/tests/cell_suite.tw
...
**Files:**
- Create: `examples/performance/dataframe/frame/column.tw`
- Create: `examples/performance/dataframe/tests/column_suite.tw`
- Modify: `examples/performance/dataframe/main.tw`
...
Add to `examples/performance/dataframe/main.tw` — import `use tests.column_suite` and add `column_suite.suite(),` to the `run_all` list. The file becomes:
...
```bash
git add examples/performance/dataframe/frame/column.tw examples/performance/dataframe/tests/column_suite.tw examples/performance/dataframe/main.tw
...
**Files:**
- Create: `examples/performance/dataframe/frame/table.tw`
- Create: `examples/performance/dataframe/tests/table_suite.tw`
- Modify: `examples/performance/dataframe/main.tw`
...
Add `use tests.table_suite` and `table_suite.suite(),` to `examples/performance/dataframe/main.tw`.

Run: `TWK_TEST_FILTER="table" target/twk run examples/performance/dataframe/main.tw`
Expected: PASS — `table` suite green.

Then format: `target/twk fmt examples/performance/dataframe/frame/table.tw`

- [ ] **Step 5: Commit**

```bash
git add examples/performance/dataframe/frame/table.tw examples/performance/dataframe/tests/table_suite.tw examples/performance/dataframe/main.tw
...
**Files:**
- Create: `examples/performance/dataframe/frame/row.tw`
- Create: `examples/performance/dataframe/tests/row_suite.tw`
- Modify: `examples/performance/dataframe/main.tw`
...
Add `use tests.row_suite` and `row_suite.suite(),` to `examples/performance/dataframe/main.tw`.

Run: `TWK_TEST_FILTER="row" target/twk run examples/performance/dataframe/main.tw`
Expected: PASS — `row` suite green.

Then format: `target/twk fmt examples/performance/dataframe/frame/row.tw`

- [ ] **Step 5: Commit**

```bash
git add examples/performance/dataframe/frame/row.tw examples/performance/dataframe/tests/row_suite.tw examples/performance/dataframe/main.tw
...
**Files:**
- Create: `examples/performance/dataframe/frame/query.tw`
- Create: `examples/performance/dataframe/tests/query_suite.tw`
- Modify: `examples/performance/dataframe/main.tw`
...
Add `use tests.query_suite` and `query_suite.suite(),` to `examples/performance/dataframe/main.tw`.

Run: `TWK_TEST_FILTER="query" target/twk run examples/performance/dataframe/main.tw`
Expected: PASS — `query` suite green.

Then format: `target/twk fmt examples/performance/dataframe/frame/query.tw`

- [ ] **Step 5: Commit**

```bash
git add examples/performance/dataframe/frame/query.tw examples/performance/dataframe/tests/query_suite.tw examples/performance/dataframe/main.tw
...
**Files:**
- Modify: `examples/performance/dataframe/frame/query.tw`
- Modify: `examples/performance/dataframe/tests/query_suite.tw`

- [ ] **Step 1: Add the failing tests**

Append these two `.test(...)` calls to the `query` suite chain in `examples/performance/dataframe/tests/query_suite.tw` (insert before the closing of the chain). Also add `use frame.query.{Dir}` to the imports at the top of the file.
...
Append to `examples/performance/dataframe/frame/query.tw`:
...
```bash
git add examples/performance/dataframe/frame/query.tw examples/performance/dataframe/tests/query_suite.tw
...
**Files:**
- Create: `examples/performance/dataframe/frame/csv.tw`
- Create: `examples/performance/dataframe/tests/csv_suite.tw`
- Modify: `examples/performance/dataframe/main.tw`
...
Add `use tests.csv_suite` and `csv_suite.suite(),` to `examples/performance/dataframe/main.tw`.

Run: `TWK_TEST_FILTER="csv" target/twk run examples/performance/dataframe/main.tw`
Expected: PASS — `csv` suite green.

Then format: `target/twk fmt examples/performance/dataframe/frame/csv.tw`

- [ ] **Step 5: Commit**

```bash
git add examples/performance/dataframe/frame/csv.tw examples/performance/dataframe/tests/csv_suite.tw examples/performance/dataframe/main.tw
...
**Files:**
- Modify: `examples/performance/dataframe/frame/column.tw`
...
Append to `examples/performance/dataframe/frame/column.tw`:
...
**Files:**
- Create: `examples/performance/dataframe/frame/group.tw`
- Create: `examples/performance/dataframe/tests/group_suite.tw`
- Modify: `examples/performance/dataframe/main.tw`
...
Add `use tests.group_suite` and `group_suite.suite(),` to `examples/performance/dataframe/main.tw`.

Run: `TWK_TEST_FILTER="group" target/twk run examples/performance/dataframe/main.tw`
Expected: PASS — `group` suite green.

Then format: `target/twk fmt examples/performance/dataframe/frame/group.tw`

- [ ] **Step 5: Commit**

```bash
git add examples/performance/dataframe/frame/group.tw examples/performance/dataframe/tests/group_suite.tw examples/performance/dataframe/main.tw
...
**Files:**
- Modify: `examples/performance/dataframe/frame/group.tw`
- Modify: `examples/performance/dataframe/tests/group_suite.tw`

- [ ] **Step 1: Add the failing tests**

Append to the `group` suite chain in `examples/performance/dataframe/tests/group_suite.tw` (and add `use frame.column.{DType}` to imports if a dtype assertion is wanted; not required below):
...
Append to `examples/performance/dataframe/frame/group.tw`:
...
```bash
git add examples/performance/dataframe/frame/group.tw examples/performance/dataframe/tests/group_suite.tw
...
**Files:**
- Create: `examples/performance/dataframe/frame/join.tw`
- Create: `examples/performance/dataframe/tests/join_suite.tw`
- Modify: `examples/performance/dataframe/main.tw`
...
Add `use tests.join_suite` and `join_suite.suite(),` to `examples/performance/dataframe/main.tw`.
...
```bash
git add examples/performance/dataframe/frame/join.tw examples/performance/dataframe/tests/join_suite.tw examples/performance/dataframe/main.tw
...
Run: `target/twk fmt examples/performance/dataframe/frame/cell.tw examples/performance/dataframe/frame/column.tw examples/performance/dataframe/frame/table.tw examples/performance/dataframe/frame/row.tw examples/performance/dataframe/frame/query.tw examples/performance/dataframe/frame/csv.tw examples/performance/dataframe/frame/group.tw examples/performance/dataframe/frame/join.tw`
Expected: no diff on a second run.

- [ ] **Step 3: Commit any formatting changes**

```bash
git add -A examples/performance/dataframe
...
**Files:**
- Create: `examples/performance/dataframe/frame/gen.tw`
- Create: `examples/performance/dataframe/tests/gen_suite.tw`
- Modify: `examples/performance/dataframe/main.tw`
...
Add `use tests.gen_suite` and `gen_suite.suite(),` to `examples/performance/dataframe/main.tw`.

Run: `TWK_TEST_FILTER="gen" target/twk run examples/performance/dataframe/main.tw`
Expected: PASS — `gen` suite green.

Then format: `target/twk fmt examples/performance/dataframe/frame/gen.tw`

- [ ] **Step 5: Commit**

```bash
git add examples/performance/dataframe/frame/gen.tw examples/performance/dataframe/tests/gen_suite.tw examples/performance/dataframe/main.tw
...
**Files:**
- Create: `examples/performance/dataframe/bench/main.tw`
...
Run: `target/twk run examples/performance/dataframe/bench/main.tw`
...
```bash
target/twk run examples/performance/dataframe/bench/main.tw | tee /tmp/dataframe-bench.txt
```

- [ ] **Step 4: Commit**

```bash
git add examples/performance/dataframe/bench/main.tw
...
**Files:**
- Create: `docs/plans/performance/dataframe/friction-log.md`

- [ ] **Step 1: Write the friction log**

Create `docs/plans/performance/dataframe/friction-log.md` with these sections, filled in from real experience during Tasks 1–15 (not invented):

```markdown
# Dataframe stress test — friction log

Companion to `docs/plans/performance/dataframe/stress-test.md`. Records what building a
