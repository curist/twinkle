...
| [typed-vector-make-and-bool-parity-design.md](typed-vector-make-and-bool-parity-design.md) | Typed `Vector.make` + Bool field/payload/gather parity | **Track A landed** (`eebcc061`); Track B needed no fix — Bool already has full Int parity in functions (see doc's Outcome) |
