...
| [typed-vector-make-and-bool-parity-design.md](typed-vector-make-and-bool-parity-design.md) | Follow-up design for typed `Vector.make` and Bool field/payload/gather parity, ordered to unblock the dataframe null-mask path | draft design |
