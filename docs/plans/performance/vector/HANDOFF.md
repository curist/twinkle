...
target/twk run examples/performance/sort-bench/value_sort_micro.tw   # native xs.sort()
```
...
- [ ] Confirm dataframe (`examples/performance/dataframe/bench/main.tw`) still behaves.
