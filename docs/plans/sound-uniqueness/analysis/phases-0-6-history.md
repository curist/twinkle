...
> The read-side borrow/loan recognition follow-up that once sat here is now an
> active work item tracked on the framework landing page ([README.md](README.md),
> "Loan/effect conflicts" engine + "Current active plans"), not in this frozen
> ledger.
