...
| Item | Home |
|---|---|
| Whole-value `MayAliasParams(k)` recovery (the `add_type` caller). **Resolved by Stage 4a** via option (b) below — no representation needed for the direct case. | **Stage 4a** ([../plans/2026-07-19-phase6-stage4a-whole-return-move.md](2026-07-19-phase6-stage4a-whole-return-move.md)) |
