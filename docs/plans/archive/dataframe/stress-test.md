...
Its own project root `examples/performance/dataframe/` (parallels `examples/leetcode/`, which has its own
...
`examples/performance/dataframe/` root **cannot import it**. CSV is therefore the primary loader
