...
To isolate the sort path, `examples/performance/dataframe/bench/order_by_micro.tw` times three pieces:
...
reference lives at `examples/performance/dataframe/bench/order_by_rust.rs`.
