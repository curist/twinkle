...
>
> **Phase 1 LSP execution plan (completed):** See [lsp-hover-goto-definition.md](lsp-hover-goto-definition.md).
>
> **LSP completion follow-up plan:** See [lsp-completion.md](lsp-completion.md).  
> **Archived LSP watched files plan:** See [lsp-file-watching.md](lsp-file-watching.md).  
> **Archived Phase 2 mixed plan:** See [lsp-diagnostics-completion.md](lsp-diagnostics-completion.md).
...
* **T1 — Formatter core** ✅
  ...
  * Archived plan: [formatter.md](formatter.md).
