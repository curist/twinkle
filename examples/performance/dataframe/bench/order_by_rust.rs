...
//!
//!   rustc -O examples/performance/dataframe/bench/order_by_rust.rs -o /tmp/order_by_rust
//!   /tmp/order_by_rust
//!
//! This mirrors `examples/performance/dataframe/bench/main.tw` for order_by only:
