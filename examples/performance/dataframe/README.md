...
tracked in [`docs/plans/performance/vector/`](../../../docs/plans/performance/vector/README.md).
...
```bash
target/twk run examples/performance/dataframe/main.tw        # test suites
target/twk run examples/performance/dataframe/bench/main.tw  # benchmarks
```
