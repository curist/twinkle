...
#
#   examples/performance/compiler/racket/run.fish
#
...
for name in $workloads
    ...
    bench_min "$twk run examples/performance/compiler/$name.tw" >$twk_out
    bench_min "racket examples/performance/compiler/racket/$name.rkt" >$rkt_out
