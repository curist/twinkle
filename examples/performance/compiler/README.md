...
[RRB-tree vector plan](../../../docs/plans/archive/rrb-vector-concat.md) **Phase 0 / Gate B**.
...
```bash
target/twk run examples/performance/compiler/<name>.tw      # prints "N<TAB>ms<TAB>sink" rows
...
[typed-dict representation plan](../../../docs/plans/archive/typed-dict-representation.md)
