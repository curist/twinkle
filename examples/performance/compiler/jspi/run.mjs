...
//
// Runs examples/performance/compiler/jspi/phase_a.wasm through the SAME async runtime path as
...
//   node examples/performance/compiler/jspi/run.mjs
//   deno run -A examples/performance/compiler/jspi/run.mjs
