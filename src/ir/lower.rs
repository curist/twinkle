...
pub mod prelude {
    ...
    // ── Raw substrate builtins (direct rt.arr access for boot/lib) ────
    // These provide low-level access so that boot/lib Twinkle code can
    // implement semantic logic (bounds checks, guards) on top.
    pub const RAW_VECTOR_I64_LEN: FuncId = FuncId(2012);
    pub const RAW_VECTOR_I64_GET_UNCHECKED: FuncId = FuncId(2013);
    pub const RAW_VECTOR_I64_SET_UNCHECKED: FuncId = FuncId(2014);
    pub const RAW_VECTOR_I64_SLICE_UNCHECKED: FuncId = FuncId(2015);
    pub const RAW_VECTOR_I64_PUSH: FuncId = FuncId(2016);
    pub const RAW_VECTOR_I64_CONCAT: FuncId = FuncId(2017);
    pub const RAW_VECTOR_I64_MAKE: FuncId = FuncId(2018);
    pub const RAW_VECTOR_I64_BUILDER_NEW: FuncId = FuncId(2019);
    pub const RAW_VECTOR_I64_BUILDER_FROM: FuncId = FuncId(2020);
    pub const RAW_VECTOR_I64_BUILDER_PUSH: FuncId = FuncId(2021);
    pub const RAW_VECTOR_I64_BUILDER_FREEZE: FuncId = FuncId(2022);
