...
fn runtime_entry(func_id: FuncId, twinkle_name: &'static str) -> Option<PreludeEntry> {
    match func_id {
        ...
        id if id == prelude_ids::VECTOR_SCRATCH_NEW => Some(PreludeEntry::runtime(
            twinkle_name,
            "rt.arr",
            "scratch_new",
            "rt_arr__scratch_new",
        ...
        id if id == prelude_ids::VECTOR_SCRATCH_GET => Some(PreludeEntry::runtime(
            twinkle_name,
            "rt.arr",
            "scratch_get",
            "rt_arr__scratch_get",
            vec![ValType::Anyref, ValType::I32],
            vec![ValType::Anyref],
        )),
        id if id == prelude_ids::VECTOR_SCRATCH_SET => Some(PreludeEntry::runtime(
            twinkle_name,
            "rt.arr",
            "scratch_set",
            "rt_arr__scratch_set",
            vec![ValType::Anyref, ValType::I32, ValType::Anyref],
            vec![],
        )),
