...
impl TypeEnv {
    pub fn new() -> Self {
        ...
        let builtin_methods: &[(TypeId, &str, &str)] = &[
            ...
            (BUILTIN_STRING_TYPE_ID, "is_empty", "String.is_empty"),
            (
            ...
            (BUILTIN_DICT_TYPE_ID, "is_empty", "Dict.is_empty"),
            // Cell
            ...
            (BUILTIN_BYTE_TYPE_ID, "is_alpha", "Byte.is_alpha"),
            (BUILTIN_BYTE_TYPE_ID, "is_alnum", "Byte.is_alnum"),
