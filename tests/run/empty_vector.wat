(module
  ...
  (func $user__func_41 (type $functype_26)
    (local $p0 (ref null $rt_types__Array))
    (local $p1 (ref null $rt_types__Array))
    (local $p2 i64)
    ...
    (local $p17 (ref null $rt_types__Array))
    (local $p18 (ref null $rt_types__Array))
    (local $p19 (ref null $rt_types__Array))
    (local $p20 i64)
    (local $p21 i64)
    (local $p22 i64)
    (local $p23 i32)
    (local $p24 (ref null $rt_types__String))
    (local $p25 (ref null $rt_types__String))
    (local $p26 i64)
    (local $p27 i32)
    (local $p28 i32)
    (local $p29 i32)
