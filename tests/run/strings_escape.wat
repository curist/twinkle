(module
  ...
  (type $functype_31 (func (param (ref null $rt_types__String)) (result (ref $rt_types__Array))))
  (type $functype_32 (func (param (ref null $rt_types__Array)) (result anyref)))
  (type $functype_33 (func (result (ref $rt_types__String))))
  ...
  (global $user____str_lit_global_6261636b5c736c617368 (mut (ref null $rt_types__String)) (ref.null $rt_types__String))
  (global $user____str_lit_global_6c696e65310a6c696e65320a (mut (ref null $rt_types__String)) (ref.null $rt_types__String))
  (global $user____str_lit_global_70726963653a20243130 (mut (ref null $rt_types__String)) (ref.null $rt_types__String))
  (global $user____str_lit_global_7361792022686922 (mut (ref null $rt_types__String)) (ref.null $rt_types__String))
  (global $user____str_lit_global_74616209656e64 (mut (ref null $rt_types__String)) (ref.null $rt_types__String))
  ...
  (func $user__func_41 (type $functype_26)
    ...
    (local $p3 i32)
    (local $p4 i32)
    call $user____str_lit_get_6c696e65310a6c696e65320a
    call $rt_core__print
    i32.const 0
    local.set $p0
    call $user____str_lit_get_74616209656e64
    call $rt_core__println
    i32.const 0
    local.set $p1
    call $user____str_lit_get_6261636b5c736c617368
    call $rt_core__println
    i32.const 0
    local.set $p2
    call $user____str_lit_get_7361792022686922
    call $rt_core__println
    i32.const 0
    local.set $p3
    call $user____str_lit_get_70726963653a20243130
  ...
  (func $user__$int_from_string_helper (type $functype_29)
    (param $p0 (ref null $rt_types__String))
    (result anyref)
    (local $p1 i64)
    (local $p2 i32)
  ...
  (func $user__$string_utf8_bytes_helper (type $functype_31)
    (param $p0 (ref null $rt_types__String))
    (result (ref $rt_types__Array))
    (local $p1 i32)
    (local $p2 i32)
  ...
  (func $user__$string_from_utf8_helper (type $functype_32)
    (param $p0 (ref null $rt_types__Array))
    (result anyref)
    (local $p1 i32)
    (local $p2 i32)
  ...
  (func $user____str_lit_get_6261636b5c736c617368 (type $functype_33)
    (result (ref $rt_types__String))
    global.get $user____str_lit_global_6261636b5c736c617368
    ref.is_null
    (if
      (then
        i32.const 98
        ...
        i32.const 115
        i32.const 104
        array.new_fixed $rt_types__String 10
        global.set $user____str_lit_global_6261636b5c736c617368))
    global.get $user____str_lit_global_6261636b5c736c617368
    ref.as_non_null
  )
  (func $user____str_lit_get_6c696e65310a6c696e65320a (type $functype_33)
    (result (ref $rt_types__String))
    global.get $user____str_lit_global_6c696e65310a6c696e65320a
    ref.is_null
    (if
      (then
        i32.const 108
        ...
        global.set $user____str_lit_global_6c696e65310a6c696e65320a))
    global.get $user____str_lit_global_6c696e65310a6c696e65320a
    ref.as_non_null
  )
  (func $user____str_lit_get_70726963653a20243130 (type $functype_33)
    (result (ref $rt_types__String))
    global.get $user____str_lit_global_70726963653a20243130
    ref.is_null
    (if
      (then
        i32.const 112
        ...
        i32.const 48
        array.new_fixed $rt_types__String 10
        global.set $user____str_lit_global_70726963653a20243130))
    global.get $user____str_lit_global_70726963653a20243130
    ref.as_non_null
  )
  (func $user____str_lit_get_7361792022686922 (type $functype_33)
    (result (ref $rt_types__String))
    global.get $user____str_lit_global_7361792022686922
    ref.is_null
    (if
      (then
        i32.const 115
        ...
        global.set $user____str_lit_global_7361792022686922))
    global.get $user____str_lit_global_7361792022686922
    ref.as_non_null
  )
  (func $user____str_lit_get_74616209656e64 (type $functype_33)
    (result (ref $rt_types__String))
    global.get $user____str_lit_global_74616209656e64
    ref.is_null
    (if
      (then
        i32.const 116
        ...
        global.set $user____str_lit_global_74616209656e64))
    global.get $user____str_lit_global_74616209656e64
    ref.as_non_null
  )
