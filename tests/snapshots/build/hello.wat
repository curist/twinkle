(module
  ...
  (func $user__func_112__closure (type $functype_54)
    (param $p0 anyref)
    (param $p1 anyref)
    (result anyref)
    local.get $p1
  ...
  (func $user__func_120__closure (type $functype_54)
    (param $p0 anyref)
    (param $p1 anyref)
    (result anyref)
    call $user__func_120
  ...
  (func $user____str_lit_get_68656c6c6f2c205477696e6b6c6521 (type $functype_60)
    (result (ref $rt_types__String))
  ...
  (func $user____str_lit_get_6e6f6e2d65786861757374697665206d6174636820696e205f5f7072656c7564655f766563746f722e6a6f696e202846756e634964283131322929 (type $functype_60)
    (result (ref $rt_types__String))
