(module
  ...
  (type $functype_27 (func (param (ref null $user__cell_Int) (ref null $user__closure_i64_i64))))
  (type $functype_28 (func))
  (type $functype_29 (func (param anyref anyref) (result anyref)))
  (type $functype_30 (func (param (ref null $rt_types__ClosureEnv) i64) (result i64)))
  ...
  (func $user__func_44 (type $functype_28)
    (local $p0 anyref)
    (local $p1 anyref)
  ...
  (func $user__func_41__typed_closure (type $functype_30)
  ...
  (func $user__func_44__closure (type $functype_29)
    (param $p0 anyref)
    (param $p1 anyref)
    (result anyref)
    call $user__func_44
  ...
  (func $user__func_43__typed_closure (type $functype_30)
    (param $p0 (ref null $rt_types__ClosureEnv))
    (param $p1 i64)
    (result i64)
    local.get $p1
  ...
  (elem declare func $user__func_41__closure $user__func_41__typed_closure $user__func_43__closure $user__func_43__typed_closure)
