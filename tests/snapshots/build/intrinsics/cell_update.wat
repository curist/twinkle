(module
  ...
  (func $user__func_91 (type $functype_52)
    (local $p0 anyref)
    (local $p1 anyref)
    ...
    local.get $p1
    ref.cast (ref null $user__cell_Int)
    ref.func $user__func_88__closure
    array.new_fixed $rt_types__ClosureEnv 0
    ref.func $user__func_88__typed_closure
    struct.new $user__closure_i64_i64
    call $user__func_89
    i32.const 0
    ref.i31
  ...
  (func $user__func_88__typed_closure (type $functype_54)
  ...
  (func $user____str_lit_get_6e6f6e2d65786861757374697665206d6174636820696e205f5f7072656c7564655f766563746f722e6a6f696e202846756e6349642838352929 (type $functype_60)
    (result (ref $rt_types__String))
  ...
  (elem declare func $user__func_88__closure $user__func_88__typed_closure $user__func_90__closure $user__func_90__typed_closure)
