(module
  ...
  (type $functype_50 (func (param i64) (result i64)))
  ...
  (func $user__func_73 (type $functype_52)
    (local $p0 anyref)
    (local $p1 anyref)
    ...
    local.get $p0
    local.set $p1
    ref.func $user__func_72__closure
    array.new_fixed $rt_types__ClosureEnv 0
    ref.func $user__func_72__typed_closure
    ...
    local.get $p1
    ref.cast (ref null $user__cell_Int)
    ref.func $user__func_70__closure
    array.new_fixed $rt_types__ClosureEnv 0
    ref.func $user__func_70__typed_closure
    struct.new $user__closure_i64_i64
    call $user__func_71
    i32.const 0
    ref.i31
  ...
  (func $user__func_72 (type $functype_50)
    (param $p0 i64)
    (result i64)
    (local $p1 i64)
    local.get $p0
  ...
  (func $user__func_67__closure (type $functype_53)
    (param $p0 anyref)
    (param $p1 anyref)
    (result anyref)
    local.get $p1
  ...
  (func $user__func_70__closure (type $functype_53)
    (param $p0 anyref)
    (param $p1 anyref)
    (result anyref)
    local.get $p1
  ...
  (func $user__func_70__typed_closure (type $functype_54)
  ...
  (func $user__func_71__closure (type $functype_53)
    (param $p0 anyref)
    (param $p1 anyref)
    (result anyref)
    local.get $p1
  ...
  (func $user__func_73__closure (type $functype_53)
    (param $p0 anyref)
    (param $p1 anyref)
    (result anyref)
    call $user__func_73
  ...
  (func $user__func_72__closure (type $functype_53)
    (param $p0 anyref)
    (param $p1 anyref)
    (result anyref)
    local.get $p1
  ...
  (func $user__func_72__typed_closure (type $functype_54)
    (param $p0 (ref null $rt_types__ClosureEnv))
    (param $p1 i64)
    (result i64)
    local.get $p1
  ...
  (func $user____str_lit_get_6e6f6e2d65786861757374697665206d6174636820696e205f5f7072656c7564655f766563746f722e6a6f696e202846756e6349642836372929 (type $functype_60)
    (result (ref $rt_types__String))
  ...
  (elem declare func $user__func_70__closure $user__func_70__typed_closure $user__func_72__closure $user__func_72__typed_closure)
