(module
  ...
  (type $functype_70 (func (param (ref null $user__cell_Int) (ref null $user__closure_i64_i64))))
  (type $functype_71 (func))
  (type $functype_72 (func (param anyref anyref) (result anyref)))
  (type $functype_73 (func (param (ref null $rt_types__ClosureEnv) i64) (result i64)))
  ...
  (func $user__func_120 (type $functype_48)
    (param $p0 i64)
    (result i64)
    (local $p1 i64)
    local.get $p0
  ...
  (func $user__func_123 (type $functype_71)
    (local $p0 anyref)
    (local $p1 anyref)
  ...
  (func $user__func_122 (type $functype_48)
    (param $p0 i64)
    (result i64)
    (local $p1 i64)
    local.get $p0
  ...
  (func $user__func_120__typed_closure (type $functype_73)
  ...
  (func $user__func_123__closure (type $functype_72)
    (param $p0 anyref)
    (param $p1 anyref)
    (result anyref)
    call $user__func_123
  ...
  (func $user__func_122__typed_closure (type $functype_73)
    (param $p0 (ref null $rt_types__ClosureEnv))
    (param $p1 i64)
    (result i64)
    local.get $p1
