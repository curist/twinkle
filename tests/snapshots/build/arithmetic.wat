(module
  ...
  (type $functype_23 (func (param i64 i64) (result i64)))
  (type $functype_24 (func))
  (type $functype_25 (func (param anyref anyref) (result anyref)))
  (type $functype_26 (func (param anyref) (result anyref)))
  ...
  (func $user__func_42 (type $functype_23)
    (param $p0 i64)
    (param $p1 i64)
    (result i64)
    (local $p2 i64)
  ...
  (func $user__func_43 (type $functype_24)
    (local $p0 i64)
  ...
  (func $user__func_41__closure (type $functype_25)
    (param $p0 anyref)
    (param $p1 anyref)
    (result anyref)
    local.get $p1
  ...
  (func $user__func_42__closure (type $functype_25)
    (param $p0 anyref)
    (param $p1 anyref)
    (result anyref)
    local.get $p1
  ...
  (func $user__func_43__closure (type $functype_25)
    (param $p0 anyref)
    (param $p1 anyref)
    (result anyref)
    call $user__func_43
  ...
  (func $user__user____iterator_next (type $functype_26)
    (param $p0 anyref)
    (result anyref)
