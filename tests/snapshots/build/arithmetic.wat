(module
  ...
  (type $functype_51 (func (param i64 i64) (result i64)))
  ...
  (func $user__func_117 (type $functype_52)
    (local $p0 i64)
    (local $p1 (ref $rt_types__String))
    (local $p2 (ref $rt_types__String))
    (local $p3 i32)
    (local $p4 i64)
    ...
    (local $p16 (ref $rt_types__String))
    (local $p17 i32)
    (local $p18 (ref $rt_types__String))
    (local $p19 (ref $rt_types__String))
    (local $p20 i32)
    (local $p21 (ref $rt_types__String))
    (local $p22 (ref $rt_types__String))
    (local $p23 i32)
    i64.const 3
    i64.const 4
    call $user__func_115
  ...
  (func $user____str_lit_get_6e6f6e2d65786861757374697665206d6174636820696e205f5f7072656c7564655f766563746f722e6a6f696e202846756e634964283130372929 (type $functype_59)
    (result (ref $rt_types__String))
