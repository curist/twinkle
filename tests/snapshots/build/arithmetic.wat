(module
  ...
  (type $rt_types__Closure (struct (field $func_ref (ref null $rt_types__ClosureFunc)) (field $env (ref null $rt_types__ClosureEnv))))
  ...
  (type $functype_22 (func (param i64 i64) (result i64)))
  (type $functype_23 (func))
  (type $functype_24 (func (param anyref anyref) (result anyref)))
  ...
  (func $rt_dict__set (type $functype_19)
    (param $p0 (ref null $rt_types__Dict))
    (param $p1 anyref)
    (param $p2 anyref)
    (result (ref $rt_types__Dict))
  ...
  (func $rt_dict__remove (type $functype_20)
    (param $p0 (ref null $rt_types__Dict))
    (param $p1 anyref)
    (result (ref $rt_types__Dict))
    (local $p2 i32)
  ...
  (func $rt_core__eq (type $functype_21)
    (param $p0 anyref)
    (param $p1 anyref)
    (result i32)
    local.get $p0
    ...
    (if
      (then
        ...
        return))
    local.get $p0
    ref.cast (ref null $rt_types__BoxedInt)
    ref.is_null
    i32.eqz
    local.get $p1
    ref.cast (ref null $rt_types__BoxedInt)
  ...
  (func $user__func_39 (type $functype_22)
    (param $p0 i64)
    (param $p1 i64)
    (result i64)
    (local $p2 i64)
  ...
  (func $user__func_40 (type $functype_23)
    (local $p0 i64)
  ...
  (func $user__func_39__closure (type $functype_24)
    (param $p0 anyref)
    (param $p1 anyref)
    (result anyref)
    local.get $p1
  ...
  (func $user__func_40__closure (type $functype_24)
    (param $p0 anyref)
    (param $p1 anyref)
    (result anyref)
    call $user__func_40
